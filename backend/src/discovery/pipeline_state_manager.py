...
VALID_TRANSITIONS = {
    "DISCOVERED": {"VERIFICATION_PENDING", "VERIFIED", "VERIFICATION_FAILED"},  # VERIFIED for Fast Path, FAILED for immediate rejection
    "VERIFICATION_PENDING": {"VERIFYING", "VERIFICATION_FAILED"},
    "VERIFYING": {"VERIFIED", "VERIFICATION_FAILED"},
    "VERIFIED": {"CRAWL_PENDING", "VERIFICATION_FAILED"},
    "CRAWL_PENDING": {"CRAWLING", "CRAWL_FAILED"},
    "CRAWLING": {"ACTIVE", "CRAWL_FAILED", "CRAWL_PENDING", "CRAWLING"},
    "ACTIVE": {"ACTIVE", "CRAWL_PENDING", "CRAWLING", "CRAWL_FAILED", "VERIFYING", "VERIFIED", "VERIFICATION_FAILED", "VERIFICATION_PENDING"},
    "VERIFICATION_FAILED": {"VERIFICATION_PENDING", "DISCOVERED", "VERIFYING", "VERIFIED"},  # Allow retry & re-verification
    "CRAWL_FAILED": {"CRAWL_PENDING", "VERIFIED"},  # Allow retry
}
