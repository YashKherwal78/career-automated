...
import { getUser, isLoggedIn, exchangeCodeForTokens } from './lib/auth';
...
function ProtectedRoute({ children }: { children: React.ReactNode }) {
  return isLoggedIn() ? <>{children}</> : <Navigate to="/applywithai" replace />;
}
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/applywithai" element={<LandingPage />} />
