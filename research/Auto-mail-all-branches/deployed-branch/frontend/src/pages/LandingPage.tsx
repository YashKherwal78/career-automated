    ...
    <div className="min-h-screen bg-geo-obsidian overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 bg-hex-grid animate-tessellate">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto px-6">
          ...
          <p className="text-lg text-geo-muted max-w-xl mx-auto mb-10 leading-relaxed animate-slide-up delay-200 font-body">
            Scrape job postings, discover recruiter contacts, generate personalized emails, 
            and send them — all from one unified pipeline.
          </p>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-mono text-3xl font-bold text-geo-text mb-3">
              The <span className="text-gradient-teal">Pipeline</span>
            </h2>
            <p className="text-geo-muted text-sm max-w-md mx-auto">
              Four precision-engineered stages. One click to orchestrate.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <FeatureCard
              icon="🔬"
              title="Scrape & Parse"
              desc="Paste a LinkedIn job URL. Our scraper extracts the JD, company name, recruiter details, and company website in seconds."
              delay="delay-100"
            />
            <FeatureCard
              icon="🔎"
              title="Find Contacts"
              desc="Cascading email lookup: JD text → Hunter.io → GetProspect. Round-robin API rotation ensures maximum coverage."
              delay="delay-200"
            />
            <FeatureCard
              icon="✍️"
              title="Generate Email"
              desc="Groq-powered LLM crafts a personalized cold email tailored to the role, company research, and your background."
              delay="delay-300"
            />
            <FeatureCard
              icon="📤"
              title="Send via Gmail"
              desc="Send directly from your Gmail account with OAuth — no app passwords needed. Resume PDF attached automatically."
              delay="delay-400"
            />
          </div>
        </div>
      ...
      <footer className="py-8 border-t border-geo-teal/5">
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between text-xs text-geo-dim">
          <span className="font-mono">ApplyWithAI</span>
