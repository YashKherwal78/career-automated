...
const PILLARS = [
  {
    icon: Radar,
    title: "Coverage",
    body: "We track company hiring directly, not just what's posted on job boards.",
  },
  {
    icon: Scale,
    title: "Fairness",
    body: "Every student gets the same visibility, regardless of college tier.",
  },
  {
    icon: Compass,
    title: "Focus",
    body: "Less time searching means more time actually preparing for interviews.",
  },
];
...
const STEPS = [
  {
    icon: Radar,
    title: "Track",
    body: "We continuously monitor career pages and ATS platforms across India.",
  },
  {
    icon: Target,
    title: "Match",
    body: "We rank roles by how well they fit your resume, not just keywords.",
  },
  {
    icon: Bell,
    title: "Notify",
    body: "You hear about roles the same day they open — not the same week.",
  },
];
    ...
    <div>
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-6 pb-16 pt-24 text-center">
          <div className="text-xs font-medium uppercase tracking-widest text-[color:var(--peach-deep)]">
            About
          </div>
      ...
      <section className="mx-auto max-w-3xl px-6 pb-24">
        <div className="glass-card rounded-3xl p-10">
          ...
          <div className="mt-4 space-y-5 font-display text-2xl leading-snug text-ink md:text-[26px]">
            <p>
              I'm a final-year engineering student at IIT Roorkee. Even at a college known for
              strong placements, I watched classmates at other colleges — just as talented,
              sometimes more — miss out on opportunities simply because recruiters never visited
              their campus.
            </p>
            <p className="italic">That felt unfair in a way that had nothing to do with ability.</p>
            <p>
              So I built CareerAutomated: a system that watches company career pages the way a
              placement cell would, for students who don't have one.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mt-10 flex flex-col items-start gap-6 rounded-3xl border hairline bg-[color:var(--peach-soft)]/40 p-8 md:flex-row md:items-center">
            ...
            <div>
              ...
              <div className="text-sm text-ink-soft">
                Final-year engineering student · IIT Roorkee
              </div>
              <p className="mt-3 max-w-lg text-sm text-ink-soft">
                Building CareerAutomated openly — sharing progress, coverage, and honest limits. If
                you're a student who wants early access, write to us.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-t hairline bg-[color:var(--peach-soft)]/40">
        <div className="mx-auto max-w-3xl px-6 py-24 text-center">
          ...
          <Link to="/signup" className="btn-peach mt-8">
            <Zap className="h-4 w-4" /> Upload your resume <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </section>
    </div>
