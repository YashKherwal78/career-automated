...
## Corpus Check
- 636 files · ~2,069,649 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4227 nodes · 7453 edges · 378 communities (253 shown, 125 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 750 edges (avg confidence: 0.51)
...
## Communities (378 total, 125 thin omitted)

### Community 0 - "Config"
Cohesion: 0.05
Nodes (22): analyze_failure(), generate_discovery_failure_report(), Returns (Failure Reason, Next Action), Returns (verification_status, http_status), verify_url(), generate_daily_queue(), Generates the daily application queue by isolating the top 20 HIGH priority jobs, Config (+14 more)
...
Cohesion: 0.11
Nodes (34): ContinuousDiscoveryEngine, DiscoveryDB, Any, BrowserSearchSource, Fallback discovery mechanism using a secondary Exa search strategy.     (Replace, Any, ReplayCache, DiscoveryContext (+26 more)

### Community 3 - "ApifyManager"
Cohesion: 0.05
Nodes (27): GoogleJobsBoardProvider, Google Jobs Pipeline B provider.  Wraps GoogleJobsProvider using the JobBoardPro, Pipeline B adapter over the existing GoogleJobsProvider., GoogleJobsProvider, JobBoardProvider, JobBoardResult, ABC, Pipeline B — Job Board Provider base interface.  All Pipeline B providers implem (+19 more)

### Community 4 - "SourceInspector"
Cohesion: 0.06
Nodes (19): AshbyInspector, ABC, e.g., 'greenhouse', 'ashby' - must match the adapter's source_name, Validates the URL using the provider's native API., Abstract interface for verifying that a detected URL is a valid,     functioning, SourceInspector, BreezyInspector, GreenhouseInspector (+11 more)
...
Cohesion: 0.04
Nodes (46): eslint, eslint-config-prettier, @eslint/js, eslint-plugin-prettier, eslint-plugin-react-hooks, eslint-plugin-react-refresh, devDependencies, eslint (+38 more)

### Community 9 - "CredentialFactory"
Cohesion: 0.08
Nodes (15): CredentialFactory, IndeedConnector, Any, LinkedinConnector, Any, Any, Executes the platform-specific search logic and returns (raw_jobs, warnings)., Overrides DiscoveryConnector.discover to implement Search Escalation Policy. (+7 more)
...
Cohesion: 0.09
Nodes (16): BoardIdentity, GreenhouseBoardIdentity, LeverBoardIdentity, SelectionResult, StandardBoardIdentity, VerifiedCandidate, WorkdayBoardIdentity, BoardIngestionEngine (+8 more)
...
Cohesion: 0.11
Nodes (22): DetectorRegistry, Central registry of ATS detectors., Pipeline B — Company Resolver.  Resolves a free-text company name + apply URL fr, ConnectorExecutor, ExecutionResult, Executes a single session under the concurrency semaphore., PlanningContextBuilder, BoardSyncSession (+14 more)
...
Cohesion: 0.16
Nodes (8): BoardSyncTask, BoardRepository, Scheduler, Queue, Scheduler, main(), TestScheduler, main()

### Community 20 - "WorkflowState"
Cohesion: 0.11
Nodes (14): ApplicationHandler, Native Playwright handler for Wellfound 'Easy Apply' flows., WellfoundHandler, get_jobs_by_stage(), log_heartbeat(), update_job_state(), PipelineStage, Enum (+6 more)

### Community 21 - "DiscoveryPlugin"
Cohesion: 0.06
Nodes (14): DiscoveryPlugin, Any, Name of the ATS provider (e.g. 'greenhouse', 'workday'), Domains used to construct URL guesses., URL fragments or text used to identify this ATS., Parse a URL into an identity and confidence score., Returns the specific inspector for this ATS., Calculates final verification confidence from inspection evidence. (+6 more)
...
### Community 25 - "Board"
Cohesion: 0.09
Nodes (11): AmazonJSONConnector, BambooHRConnector, WorkableJSONConnector, Board, FetchResult, HttpClient, Any, Yields RawJobs incrementally. The connector owns its own pagination. (+3 more)
...
Cohesion: 0.14
Nodes (12): Credential, CredentialExhaustedException, CredentialTelemetry, InMemoryCredentialProvider, load_generic_credentials(), load_google_credentials(), ProviderDefinition, Any (+4 more)

### Community 29 - "RawJob"
Cohesion: 0.13
Nodes (18): CanonicalJob, JobIdentity, RawJob, Convert a StandardJob to a CanonicalJob.          Args:             job:      St, JobValidator, Returns (valid_jobs, invalid_records)., Validates jobs before persistence to prevent corrupt data., Returns a list of error messages. Empty list means valid. (+10 more)

### Community 30 - "LLMRouter"
Cohesion: 0.10
Nodes (14): get_lead_by_hr_email(), log_llm_usage(), ApplicationJudge, CriticRejection, Exception, classify_reply(), monitor_inbox(), GroqManager (+6 more)
...
Cohesion: 0.09
Nodes (21): CompanyResolver, _domain_slug(), _extract_domain(), Push a discovery payload into discovery_queue so Pipeline A will         detect, Extract bare domain from any URL, stripping www., Stable, collision-resistant company_id from a domain., Resolves StandardJob.company + apply_url to an existing company_id.      Resolut, Args:             db_path: Path to the SQLite database.             queue:   A S (+13 more)

### Community 34 - "DefaultFreshnessStrategy"
Cohesion: 0.14
Nodes (11): GreenhouseConnector, GreenhouseJSONConnector, LeverConnector, LeverJSONConnector, OracleJSONConnector, TeamtailorJSONConnector, ConnectorCapability, DefaultFreshnessStrategy (+3 more)
...
Cohesion: 0.09
Nodes (12): FeedbackTracker, outcome should be 'INTERVIEW' or 'REJECTED', MatchEngine, Enforces the V1.4 target distribution by percentiles:         Top 5% -> 90+, Evaluates discovered jobs against the Candidate Intelligence DB     Returns a sc, insert_discovered_job(), Inserts a job if URL is unique. Returns True if inserted, False if duplicate., WellfoundDailyCron (+4 more)
...
Cohesion: 0.12
Nodes (19): add_or_update_lead(), get_lead(), Upserts a lead based on company_name, update_lead_state(), _determine_company_size(), enrich_company(), EnrichmentProvider, GetProspectProvider (+11 more)
...
Cohesion: 0.16
Nodes (15): Any, EndpointIntelligence, PlanningContext, PlanningContextBuilder, Any, RuntimeState, CrawlPlanner, CrawlPlan (+7 more)
...
Cohesion: 0.13
Nodes (23): _categorize(), collect_evidence(), Candidate, rank_candidates(), RankedCandidate, CandidateEvaluator — Sprint C1B  Evidence Collection → Scoring → Ranking → Thres, Assign a coarse category purely from URL structure. No network calls., Collects all available structural evidence for a candidate URL.     This does NO (+15 more)
...
Cohesion: 0.13
Nodes (13): AutoapplyEngine, Maps the recommended resume string from the DB to an absolute resume path, RAGClient, Dynamically generates chunks from yash_master_profile.md., Retrieves Top 5 chunks using BM25, then reranks, returning the Final Top chunks., compile_and_count_pages(), extract_numbers(), extract_projects_from_tex() (+5 more)

### Community 55 - "CompanyDiscoveryWorker"
Cohesion: 0.15
Nodes (12): PipelineStateManager, Any, Exception, Executes a lifecycle transition for a batch of companies atomically., Executes a lifecycle transition atomically within a single database transaction., TransitionError, CompanyDiscoveryWorker, extract_domain() (+4 more)

### Community 56 - "Connector"
Cohesion: 0.15
Nodes (8): SmartRecruitersConnector, Connector, Base interface for ATS Connectors.     A Connector strictly handles provider com, Returns the crawl policy configuration for this connector., ConnectorRegistry, Returns the highest priority connector instance for the provider., Returns a list of connector classes that match all specified capability flags., StrategyRegistration

### Community 57 - ".run_async"
Cohesion: 0.11
Nodes (13): ConfidenceFormula, EndpointIntelligenceService, Any, Called when an endpoint candidate fails verification (e.g. 404, invalid signatur, Called by JobCrawlerWorker after a successful sync., Called by JobCrawlerWorker after a sync fails., confidence = provider_weight + historical_success + freshness + evidence - histo, Centralized service for managing confidence, health, and history of ATS endpoint (+5 more)
...
Cohesion: 0.19
Nodes (10): ConnectorRegistry, Runtime registry for all Discovery Connectors.     Reads config, instantiates cl, AshbyConnector, AshbyJSONConnector, WorkdayConnector, WorkdayJSONConnector, CrawlPolicy, CrawlPriority (+2 more)
...
Cohesion: 0.21
Nodes (5): CompatCursor, Any, table_exists(), get_dashboard_summary(), get_discovery_queues()
...
Cohesion: 0.15
Nodes (8): ProviderRegistry, BaseProvider, Registers a BaseProvider subclass., Returns instantiated versions of all registered providers., Factory for instantiating Discovery Providers.     Follows the plugin architectu, Candidate, Parses /sitemap.xml to find careers, jobs, and external ATS URLs., SitemapStrategy
...
Cohesion: 0.08
Nodes (15): _enqueue_batch(), migrate_existing_companies(), is_postgres(), MigrationRunner, BaseRepository, Override in subclasses to create schema., CareerEndpointRepository, Connection (+7 more)
...
Cohesion: 0.15
Nodes (13): dependencies, input-otp, @radix-ui/react-checkbox, @radix-ui/react-radio-group, @radix-ui/react-switch, react-day-picker, @tanstack/react-query, input-otp (+5 more)
...
Cohesion: 0.20
Nodes (3): BreezyParser, BreezyDiscoveryPlugin, Any
...
Cohesion: 0.07
Nodes (16): ATSRegistry, Connection, VerificationResult, Promotes a VerificationResult to ACTIVE status.         Compares endpoint_hash t, Promotes a batch of endpoints in a single transaction.         Each item in batc, For regression safety: creates a backup of the current ats_registry table., FastPathRegistry, Any (+8 more)
...
Cohesion: 0.25
Nodes (3): DefaultInspector, Fallback validator for ATS providers that don't have a dedicated API validator y, Returns the inspector by name, or a DefaultInspector if none is registered.
...
- **Why does `Config` connect `Config` to `EventBus`, `ApifyManager`, `CompanyIntelligenceEngine`, `dotenv`, `ProfileParser`, `get_connection`, `OutreachEngine`, `WorkflowState`, `ranking.py`, `CredentialProvider`, `EnrichmentLayer`, `run_batch.py`, `LLMRouter`, `EligibilityRuleProvider`, `WellfoundScraper`, `add_or_update_lead`, `process_job`, `provider_effectiveness.py`, `ProfileManager`, `DiscoveryQueue`, `main.py`, `RAGClient`, `DiscoverySession`, `database.py`, `funnel.py`, `quality_filter.py`, `executor.py`, `ApplicationExecutor`, `ATSRegistry`?**
