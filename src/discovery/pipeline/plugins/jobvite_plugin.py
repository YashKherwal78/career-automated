...
from src.discovery.inspectors.jobvite_inspector import JobviteInspector
from src.discovery.pipeline.parsers import JobviteParser

class JobviteDiscoveryPlugin(DiscoveryPlugin):
    def __init__(self):
        self.parser = JobviteParser()
